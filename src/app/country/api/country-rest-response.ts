...
export interface CountryRestResponse {
    tld: string[];
    cca2: string;
    ccn3: string;
    cca3: string;
...
export class Convert {
    public static toCountryResponse(json: string): CountryRestResponse[] {
        return cast(JSON.parse(json), a(r("CountryResponse")));
    }

    public static countryResponseToJson(value: CountryRestResponse[]): string {
...
const typeMap: any = {
    ...
    "NativeName": o([
        { json: "est", js: "est", typ: r("Translation") },
    ], false),
    "Translation": o([
        { json: "official", js: "official", typ: "" },
        { json: "common", js: "common", typ: "" },
