...
import { CacheCleanSettings } from "./views/cache-clean-settings/cache-clean-settings";

@Component({
  selector: 'settings-modal-config',
  imports: [DelaySettings, ThemeSettings, DebounceTimeSettings, CacheCleanSettings],
